...
struct WelcomeIcon: View {
    ...
    var body: some View {
        ...
        Image("WelcomeIcon")
            ...
            .shadow(color: Color(red: 0.46, green: 0.86, blue: 0.00), radius: 60, x: -10, y: 10)
            .shadow(color: Color(red: 0.86, green: 0.98, blue: 0.29), radius: 30, x: 10, y: 15)
            .shadow(color: Color(red: 0.67, green: 1.00, blue: 0.00), radius: 60, x: 18, y: -10)
            .rotation3DEffect(
