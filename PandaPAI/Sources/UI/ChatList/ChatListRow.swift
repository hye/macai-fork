...
struct ChatListRow: View, Equatable {
    ...
    func deleteChat(_ chat: ChatEntity) {
        ...
        #else
        // On iOS, implement deletion without alert for now
        if selectedChat?.id == chat.id {
            selectedChat = nil
        }
        viewContext.delete(chat)
    ...
    func renameChat(_ chat: ChatEntity) {
        ...
        #else
        // On iOS, implement rename functionality without alert for now
        // Could use a SwiftUI Alert with TextField in the future
        print("Rename functionality not implemented for iOS yet")
        #endif
    }
    ...
    func clearChat(_ chat: ChatEntity) {
        ...
        #else
        // On iOS, implement clear functionality without alert for now
        chat.clearMessages()
        do {
            try viewContext.save()
        } catch {
